...
This repository contains simple Python functions along with automated test cases written using pytest. It's meant to demonstrate core QA/testing skills, including:
